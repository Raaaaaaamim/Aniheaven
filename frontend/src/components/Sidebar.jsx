...
const Sidebar = () => {
  return (
    <div className=" fixed left-0 hidden lg:flex lg:flex-col lg:justify-center lg:items-center top-0  h-[100vh] lg:w-[18%] border-border border-r-[1px]  ">
      <div className=" gap-0 2xl:gap-[5%] flex flex-col h-full w-[90%] ml-[20px] ">
