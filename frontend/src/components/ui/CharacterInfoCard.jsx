...
const CharacterInfoCard = ({ title, role, image, delay = 0 }) => (
  <motion.div
    ...
    className="group"
  >
    <div className="relative backdrop-blur-sm rounded-xl overflow-hidden  border-[1px] border-white/[0.05]">
        ...
        <div className="absolute inset-x-0 bottom-0 p-3 md:p-4">
          <div className="space-y-2 md:space-y-3">
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1.5 md:gap-2 bg-background/20 px-2 md:px-3 py-1 md:py-1.5 rounded-full backdrop-blur-sm border border-white/[0.05]">
