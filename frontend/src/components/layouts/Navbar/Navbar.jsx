        ...
        <div className="ml-6 flex justify-center gap-11 items-center">
          <div className="hidden lg:flex gap-3">
            <button className="p-2.5 rounded-lg hover:bg-white/5 active:bg-white/10 transition-colors">
              <MdOutlineArrowBackIos className="text-lg text-gray-text hover:text-text transition-colors" />
            </button>
            <button className="p-2.5 rounded-lg hover:bg-white/5 active:bg-white/10 transition-colors">
              <MdOutlineArrowForwardIos className="text-lg text-gray-text hover:text-text transition-colors" />
            </button>
          </div>
          <div
          ...
          >
            <div className="font-outfit flex justify-center items-center gap-3 w-full h-full px-4">
              ...
              <input
                className="w-full border-none bg-transparent text-sm text-gray-text outline-none placeholder:text-gray-text/70 h-full"
                type="text"
