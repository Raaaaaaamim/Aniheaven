      ...
      <div className=" w-full  flex gap-5  items-center justify-between ">
        <div className=" ml-6 flex justify-center gap-11 items-center  ">
          ...
          <div
            ...
            } overflow-hidden md:flex ml-12 gap-1 z-40 bg-background justify-start hidden  items-center  h-10 lg:w-72 md:w-64 w-60 rounded-xl flex-col border-border border-[1px]  `}
          >
            <div
              className={
                " font-outfit  flex justify-center items-center gap-1 w-[90%] h-full "
              }
            >
