    ...
    <div className="lg:w-[100%] 2xl:max-w-[1920px] flex w-full items-center flex-col min-h-[100vh] p-4 justify-center">
      ...
      <div className="mt-5 lg:ml-3 w-full max-w-8xl">
        ...
        <div className="flex w-full whitespace-nowrap overflow-hidden gap-4 2xl:gap-9">
          {[...Array(7)].map((_, i) => (
            <div
              key={i}
              className="relative shrink-0 border-border border-[1px] font-poppins w-[220px] h-[280px] md:w-[220px] md:h-[300px] lg:w-[190px] lg:h-[270px] xl:w-[200px] xl:h-[280px] 2xl:w-[220px] 2xl:h-[300px] rounded-xl overflow-hidden bg-[#1f1f1f] animate-pulse"
            ></div>
          ))}
        </div>
      </div>
      ...
      <div className="gap-[16px] mt-[40px] flex-col w-full flex justify-center items-center flex-wrap min-h-[10vh]">
        <div className="max-w-8xl flex flex-col gap-8">
          <div className="self-start md:text-2xl text-2xl border-l-4 px-3 border-primary ml-2 bg-[#1f1f1f] animate-pulse h-8 w-48 rounded-xs" />
