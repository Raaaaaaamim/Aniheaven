      ...
      <div className="flex flex-col sm:flex-row h-full sm:items-end pb-4 sm:pb-8 gap-4 sm:gap-8">
        ...
        <div className="flex-1 text-text text-center sm:text-left">
          ...
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 sm:mb-3">
            <div className="h-8 sm:h-10 bg-secondary/20 rounded w-3/4 mx-auto sm:mx-0 animate-pulse" />
          </div>

          {/* Metadata */}
          <div className="flex flex-wrap justify-center sm:justify-start items-center gap-2 sm:gap-3 mb-3">
            <div className="h-4 sm:h-5 bg-secondary/20 rounded w-20 animate-pulse" />
            <div className="hidden sm:block h-4 sm:h-5 bg-secondary/20 rounded w-1 animate-pulse" />
            <div className="h-4 sm:h-5 bg-secondary/20 rounded w-16 animate-pulse" />
            <div className="hidden sm:block h-4 sm:h-5 bg-secondary/20 rounded w-1 animate-pulse" />
            <div className="h-4 sm:h-5 bg-secondary/20 rounded w-24 animate-pulse" />
            <div className="hidden sm:block h-4 sm:h-5 bg-secondary/20 rounded w-1 animate-pulse" />
            <div className="h-4 sm:h-5 bg-secondary/20 rounded w-28 animate-pulse" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-6 sm:gap-x-12 gap-y-2">
            {[
              ...
              <div key={i} className="flex gap-2 items-center">
                ...
                <div className={`h-4 bg-secondary/20 rounded ${item.width} animate-pulse`} />
              </div>
            ))}
          </div>
        </div>
